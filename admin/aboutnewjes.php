...
<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if ($title == "" || $bold_disc == "" || $discrip == "" ) {
            $nam = "<span style='color: red '>Field Must Not be empty !</span>";
        }else{

        $query = "REPLACE INTO post_cat(id,title, bold_disc, discrip) VALUES('$id','$title', '$bold_disc', '$discrip')";
...
<div class="grid_10">
            <div class="box round first grid">
                ...
                <div class="block">               
                 <form action="aboutnewjes.php" method="post" enctype="multipart/form-data">
                    <table class="form">
        <?php 
